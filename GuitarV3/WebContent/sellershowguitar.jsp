	...
	<!-- <div class="row-fluid">
	 ...
	 <div class="row-fluid">
		<div class="span12">
			...
			<input  name="delete" type="button"  id="delete"  class="Common"   onclick="form.action='deleteguitar.do';form.submit()"  value="DeleteGuitar"/>
		...
		<table class="table">
			...
			<td>
					...
					<!-- <tr>
				<td>
							 <input name="checkboxname" type="checkbox" id="checkbox1" />
						</td>
												<td> <input type="text"  name="serialNumble"></td>
